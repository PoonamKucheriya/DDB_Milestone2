...
public class PutRecord {
	 ...
	 * 
	 * String textValue = args[0]; String streamName = args[1];
	 * 
	 * Region region = Region.AP_SOUTHEAST_2; FirehoseClient firehoseClient =
	 * FirehoseClient.builder() .region(region) .build();
	 * 
